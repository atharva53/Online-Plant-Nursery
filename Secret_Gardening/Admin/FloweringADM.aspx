<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FloweringADM.aspx.cs" Inherits="Secret_Gardening.Admin.FloweringADM" %>
...
<body>
    ...
    <div>
        ...
        <asp:Image ID="Image1" runat="server" ImageUrl="~/images/Sub_Category_Banners_Cacti___Succ_Desk.png" Width="100%" />
        <br /><br />
  ...
  <div class="card-body">
    <h5 class="card-title">
      ...
      <p class="card-title">
          ...
          &nbsp;<asp:Label ID="Label22" runat="server" Font-Bold="False" Font-Size="X-Large" Text='<%# Eval("pquant") %>'></asp:Label>
          <br />
      </p>
      <br />
  </div>
