        ...
        protected void Button1_Click1(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    cmd.CommandText = "select Id from Admin WHERE A_UserId='" + tbUsernm.Text + "' AND  A_Password='" + tbPass.Text + "'";

                    int a = (int)(cmd.ExecuteScalar());
                    if (a > 0)
                    {
                        cmd.CommandText = "insert into Login values('" + tbUsernm.Text + "','" + tbPass.Text + "')";
                        cmd.ExecuteNonQuery();


                        ScriptManager.RegisterStartupScript(this, this.GetType(),
"alert",
"alert('Log In successfull..');window.location ='AddProduct.aspx';",
true);
