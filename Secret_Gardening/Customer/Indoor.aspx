<%@ Page Title="" Language="C#" MasterPageFile="~/Customer/MasterPage.Master" AutoEventWireup="true" CodeBehind="Indoor.aspx.cs" Inherits="Secret_Gardening.Customer.Indoor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Image ID="Image1" runat="server" ImageUrl="~/images/Beginner_friendly_page_-_Banner.png" Width="100%" />
    <br /><br />
    <h5  style="text-align:center">  Indoor plants are a great way to improve not only your home decor but also your health. With Ugaoo, indoor plants for home have become more accessible and exotic and easy to care for indoor plants are available at your fingertips. Buy indoor plants online from our extensive range of best indoor plants for home and turn your home into a paradise. </h5>
    <br />
